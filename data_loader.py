...
class DataLoader:
    def __init__(self, args):
        self.args = args
        self.data = pd.read_csv(self.args['fileName'], nrows=150000)
    ...
    def preprocess(self):
        ...
        self.data.loc[~self.data['country'].isin(
            ['US', 'GB']), 'country'] = 'OTHER'
        self.data['cat_sub_cat'] = self.data['main_category'] +'_'+self.data['category']
        ...
        self.data = self.data.drop(['main_category','category', 'backers'], 1)
        ...
        self.data = self.data[['cat_sub_cat','currency', 'country', 'goal_level',
