...
class DataLoader:
    ...
    def preprocess(self):
        ...
        self.data.loc[((self.data['backers_s'] > 0) & (
            self.data['backers_s'] <= 16)), 'backers_s_level'] = 1
        self.data.loc[((self.data['backers_s'] > 16) & (
            self.data['backers_s'] <= 100)), 'backers_s_level'] = 2
        self.data.loc[((self.data['backers_s'] > 100) & (
            self.data['backers_s'] <= 649)), 'backers_s_level'] = 3
